...
cosmic-applet-memory-monitor = Memory Monitor
cosmic-applet-memory-monitor-comment = Show memory usage as a ring chart in the panel
cosmic-applet-memory-monitor-keywords = COSMIC;Applet;Memory;RAM;Usage;Monitor;
