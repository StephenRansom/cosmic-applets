...
cosmic-applet-memory = Memory
cosmic-applet-memory-comment = Show memory usage as a ring chart in the panel
cosmic-applet-memory-keywords = COSMIC;Applet;Memory;RAM;Usage;Monitor;
